...
comment = Dateimanager für den WMDE Desktop
...
search = Suchen
search-placeholder = { $name } durchsuchen
...
status-selected = { $selected } ausgewählt
status-disk = { $total } | { $used } belegt | { $free } frei
